        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div className="group bg-white dark:bg-slate-800 rounded-3xl p-6 sm:p-8 shadow-sm sm:hover:shadow-xl transition-all duration-300 border border-gray-100 dark:border-gray-700 flex flex-col">
            ...
            <div className="flex items-center justify-between border-t border-gray-100 dark:border-gray-700 pt-6 mt-auto">
              ...
              <a href="#lead-capture" className="px-6 py-2 bg-purple-50 dark:bg-purple-900/20 text-purple-700 dark:text-purple-300 rounded-lg active:bg-purple-100 sm:hover:bg-purple-100 dark:active:bg-purple-900/40 dark:sm:hover:bg-purple-900/40 transition font-medium touch-manipulation">Try Free</a>
            </div>
          </div>
          ...
          <div className="group bg-white dark:bg-slate-800 rounded-3xl p-6 sm:p-8 shadow-sm sm:hover:shadow-xl transition-all duration-300 border border-gray-100 dark:border-gray-700 flex flex-col">
            ...
            <div className="flex items-center justify-between border-t border-gray-100 dark:border-gray-700 pt-6 mt-auto">
              ...
              <a href="#lead-capture" className="px-6 py-2 bg-primary text-white rounded-lg active:bg-primary-hover sm:hover:bg-primary-hover transition font-medium shadow-md shadow-primary/10 touch-manipulation">Start Generating</a>
            </div>
          </div>
